...
tests =
  ...
  , testGroup
      ...
      , fitsInto "scaleNat" [bytes| 243 |] .fromCompiledCode $ R.rScaleNat
      ]
  , testGroup
      "MultiplicativeGroup"
      [ fitsInto "*" [bytes| 151 |] . fromCompiledCode $ R.rTimes
      , fitsInto "one" [bytes| 28|] . fromCompiledCode $ R.rOne
      , fitsInto "/" [bytes| 146 |] . fromCompiledCode $ R.rDiv
      , fitsInto "reciprocal" [bytes| 92 |] . fromCompiledCode $ R.rRecip
      , fitsInto "powNat" [bytes| 348 |] . fromCompiledCode $ R.rPowNat
      , fitsInto "powInteger" [bytes| 357 |] . fromCompiledCode $ R.rPowInteger
      ]
  , testGroup
      "IntegralDomain"
      [ fitsInto "abs" [bytes| 71 |] . fromCompiledCode $ R.rAbs
      , fitsInto "projectAbs" [bytes| 71 |] . fromCompiledCode $ R.rProjectAbs
